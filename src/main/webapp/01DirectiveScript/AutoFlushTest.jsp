...
<%
/* 
for문을 통해 10글자(10btye)를 100번 반복해서 출력하므로 1000byte가 
된다. 여기에 HTML태그들이 있으므로 해당 페이지의 용량은 1kb를 초과하게
되어 실행시 에러가 발생한다. 해결방법은 buffer의 용량을 늘리거나,
...
이를 통해 에러페이지 처리나 포워드 등의 기능을 수행할수 있게 된다.
*/
%>
</body>
</html>